...
//! integration is based on the standard [`std::error::Error`] interface rather
//! than on derive-macro internals.
//!
...
//!
//! Integrations feed existing error ecosystems into `diagprint` rather than
